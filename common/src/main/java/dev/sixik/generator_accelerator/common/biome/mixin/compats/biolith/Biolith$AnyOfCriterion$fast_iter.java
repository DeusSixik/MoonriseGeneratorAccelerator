package dev.sixik.generator_accelerator.common.biome.mixin.compats.biolith;
...
@CompatMixin(mod = Biolith.class)
@Mixin(value = AnyOfCriterion.class, remap = false)
public abstract class Biolith$AnyOfCriterion$fast_iter implements Criterion {
    @Shadow
    @Final
    private List<Criterion> criteria;

    @Shadow
    public abstract CriterionType<AnyOfCriterion> getType();

    @Shadow
    public abstract MapCodec<AnyOfCriterion> getCodec();
