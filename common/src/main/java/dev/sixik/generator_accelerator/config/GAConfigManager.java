...
public class GAConfigManager {
    ...
    private static void applySystemOverrides(GAConfig config) {
        ...
        config.schedulerV2Enabled = boolOverride("ga.config.schedulerV2Enabled", config.schedulerV2Enabled);
        config.schedulerV2Mode = System.getProperty("ga.config.schedulerV2Mode", config.schedulerV2Mode);
        config.schedulerV2Workers = intOverride("ga.config.schedulerV2Workers", config.schedulerV2Workers);
        config.schedulerV2BatchMaxCenters = intOverride("ga.config.schedulerV2BatchMaxCenters", config.schedulerV2BatchMaxCenters);
        config.schedulerV2BatchMaxNodes = intOverride("ga.config.schedulerV2BatchMaxNodes", config.schedulerV2BatchMaxNodes);
        config.schedulerV2BatchMaxEdges = intOverride("ga.config.schedulerV2BatchMaxEdges", config.schedulerV2BatchMaxEdges);
        config.schedulerV2MaxArenaBytesPerBatch = longOverride("ga.config.schedulerV2MaxArenaBytesPerBatch", config.schedulerV2MaxArenaBytesPerBatch);
        config.schedulerV2MaxArenas = intOverride("ga.config.schedulerV2MaxArenas", config.schedulerV2MaxArenas);
        config.schedulerV2MaxQueuedHandlesPerWorker = intOverride("ga.config.schedulerV2MaxQueuedHandlesPerWorker", config.schedulerV2MaxQueuedHandlesPerWorker);
        config.schedulerV2MaxExternalWaiters = intOverride("ga.config.schedulerV2MaxExternalWaiters", config.schedulerV2MaxExternalWaiters);
        config.schedulerV2DebugMetrics = boolOverride("ga.config.schedulerV2DebugMetrics", config.schedulerV2DebugMetrics);
        config.schedulerV2MaxParkNanos = intOverride("ga.config.schedulerV2MaxParkNanos", config.schedulerV2MaxParkNanos);
        config.schedulerV2RollbackDrainTimeoutMicros = longOverride("ga.config.schedulerV2RollbackDrainTimeoutMicros", config.schedulerV2RollbackDrainTimeoutMicros);
        config.schedulerV2MaxMemoryBytes = longOverride("ga.config.schedulerV2MaxMemoryBytes", config.schedulerV2MaxMemoryBytes);
        config.schedulerV2ForceLegacyStatuses = System.getProperty("ga.config.schedulerV2ForceLegacyStatuses", config.schedulerV2ForceLegacyStatuses);
        config.schedulerV2CompatRefuseUnknownChunkScheduler = boolOverride("ga.config.schedulerV2CompatRefuseUnknownChunkScheduler", config.schedulerV2CompatRefuseUnknownChunkScheduler);
